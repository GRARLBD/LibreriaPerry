...
CREATE TABLE `salida` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_Salida_Producto1_idx` (`id_producto`),
  CONSTRAINT `fk_Salida_Producto` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id`)
...
-- Dump completed on 2019-12-13  1:48:14
